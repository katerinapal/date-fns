...
describe('endOfWeek', function () {
  it('returns the date with the time setted to 23:59:59:999 and the date setted to the last day of a week', function () {
    ...
    var result = (0, _.endOfWeek)(date);
    _powerAssert2.default.deepEqual(result, new Date(2014, 8 /* Sep */, 6, 23, 59, 59, 999));
  });

  it('allows to specify which day is the first day of the week', function () {
    var date = new Date(2014, 8 /* Sep */, 2, 11, 55, 0);
    var result = (0, _.endOfWeek)(date, { weekStartsOn: 1 });
  ...
  describe('edge cases', function () {
    context('when the given day is before the start of a week', function () {
      it('it returns the end of a week', function () {
        ...
        var result = (0, _.endOfWeek)(date, { weekStartsOn: 3 });
        _powerAssert2.default.deepEqual(result, new Date(2014, 9 /* Oct */, 7, 23, 59, 59, 999));
      });
    });
    ...
    context('when the given day is the start of a week', function () {
      it('it returns the end of a week', function () {
        ...
        var result = (0, _.endOfWeek)(date, { weekStartsOn: 3 });
        _powerAssert2.default.deepEqual(result, new Date(2014, 9 /* Oct */, 14, 23, 59, 59, 999));
      });
    });
    ...
    it('handles the week at the end of a year', function () {
      ...
      var result = (0, _.endOfWeek)(date, { weekStartsOn: 5 });
      _powerAssert2.default.deepEqual(result, new Date(2015, 0 /* Jan */, 1, 23, 59, 59, 999));
    });
  });
});