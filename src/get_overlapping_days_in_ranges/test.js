...
var getOverlappingDaysInRanges = _2.default;
...
describe('getOverlappingDaysInRanges', function () {
  ...
  it('throws an exception if the start date of the initial date range is after the end date', function () {
    var block = getOverlappingDaysInRanges.bind(null, new Date(2016, 10, 7), new Date(2016, 10, 3), new Date(2016, 10, 5), new Date(2016, 10, 15));
    assert.throws(block);
  });

  it('throws an exception if the start date of the compared date range is after the end date', function () {
    var block = getOverlappingDaysInRanges.bind(null, new Date(2016, 10, 3), new Date(2016, 10, 7), new Date(2016, 10, 15), new Date(2016, 10, 5));
    assert.throws(block);
  });
});