...
describe('subQuarters', function () {
  it('subtracts the given number of quarters', function () {
    var result = (0, _.subQuarters)(new Date(2014, 8 /* Sep */, 1), 3);
    _powerAssert2.default.deepEqual(result, new Date(2013, 11 /* Dec */, 1));
  });

  it('accepts a string', function () {
    var result = (0, _.subQuarters)(new Date(2014, 8 /* Sep */, 1).toISOString(), 4);
    _powerAssert2.default.deepEqual(result, new Date(2013, 8 /* Sep */, 1));
  });

  it('accepts a timestamp', function () {
    var result = (0, _.subQuarters)(new Date(2014, 8 /* Sep */, 1).getTime(), 4);
    _powerAssert2.default.deepEqual(result, new Date(2013, 8 /* Sep */, 1));
  });
  ...
  it('handles dates before 100 AD', function () {
    ...
    var result = (0, _.subQuarters)(initialDate, 3);
