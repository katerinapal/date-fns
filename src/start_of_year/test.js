...
describe('startOfYear', function () {
  it('returns the date with the time setted to 00:00:00 and the date setted to the first day of a year', function () {
    ...
    var result = _startOfYear(date)
    ext_assert.deepEqual(result, new Date(2014, 0 /* Jan */, 1, 0, 0, 0, 0))
  })
  ...
  it('accepts a timestamp', function () {
    ...
    var result = _startOfYear(date)
    ext_assert.deepEqual(result, new Date(2014, 0 /* Dec */, 1, 0, 0, 0, 0))
  })
  ...
  it('handles dates before 100 AD', function () {
    ...
    var result = _startOfYear(initialDate)
