...
describe('addHours', function () {
  it('adds the given numbers of hours', function () {
    var result = _addHours(new Date(2014, 6 /* Jul */, 10, 23, 0), 2)
    ext_assert.deepEqual(result, new Date(2014, 6 /* Jul */, 11, 1, 0))
  })

  it('accepts a string', function () {
    var result = _addHours(
      new Date(2014, 6 /* Jul */, 10, 23, 0).toISOString(), 26
    )
    ext_assert.deepEqual(result, new Date(2014, 6 /* Jul */, 12, 1, 0))
  })
