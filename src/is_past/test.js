...
describe('isPast', function () {
  ...
  it('returns true if the given date is in the past', function () {
    var result = (0, _.isPast)(new Date(2014, 6 /* Jul */, 2));
    (0, _powerAssert2.default)(result === true);
  });

  it('returns false if the given date is in the future', function () {
    var result = (0, _.isPast)(new Date(2014, 11 /* Dec */, 31));
    (0, _powerAssert2.default)(result === false);
  });

  it('returns false if the given date is now', function () {
    var result = (0, _.isPast)(new Date(2014, 8 /* Sep */, 25));
    (0, _powerAssert2.default)(result === false);
  });

  it('accepts a string', function () {
    var result = (0, _.isPast)(new Date(2014, 6 /* Jul */, 2).toISOString());
    (0, _powerAssert2.default)(result === true);
  });

  it('accepts a timestamp', function () {
    var result = (0, _.isPast)(new Date(2014, 6 /* Jul */, 2).getTime());
    (0, _powerAssert2.default)(result === true);
  });
});